...
public class ListMultiSportCenterFrame extends javax.swing.JFrame {
    ...
    public ListMultiSportCenterFrame() throws DAOException {
        initComponents();
        this.model = new MultiSportCenterTablaModel(new MultiSportCenterDAO());
        getData();
    ...
    private MultiSportCenter getSelectedMultiSportCenter() throws DAOException {
        ...
        return new MultiSportCenterDAO().getMSC(id);
    }
    ...
    private void BEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BEditActionPerformed
        try {
            ...
            ex = new DAOException("Error al editar");
        }
    }//GEN-LAST:event_BEditActionPerformed

    private void BDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BDeleteActionPerformed
        try {
            MultiSportCenter msc = getSelectedMultiSportCenter();
            if (msc.getnAreas() == 0) {
                if (JOptionPane.showConfirmDialog(rootPane, "¿Seguro que quieres borrar "
                    ...
                    new MultiSportCenterDAO(msc).deleteMSC();
                    getData();
                }
            } else {
                JOptionPane.showMessageDialog(rootPane, "No puedes borrar un Multideportivo "
                        + "hasta borrar todas sus areas", "Error borrar Multideportivo",
    ...
    private void BSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSaveActionPerformed
        try {
            if (Details.checkData()) {
                ...
                if (isNew) {
                    new MultiSportCenterDAO(multiSportCenter).insertMSC();
                } else {
                    new MultiSportCenterDAO(multiSportCenter).modifyMSC(multiSportCenter.getId());
                }
                Details.setMultiSportCenter(null);
            ...
            ex = new DAOException("Error al guardar");
        }
